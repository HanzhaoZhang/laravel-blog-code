...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <textarea name="meta_description" id="meta_description" rows="3">{{ $meta_description }}</textarea>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <input type="text form-control" name="layout" id="layout" value="{{ $layout }}">
    </div>
</div>

<div class="form-group row">
    <label for="reverse_direction" class="col-md-3 col-form-label">排序</label>
    <div class="col-md-7">
        <label class="radio-iniline">
