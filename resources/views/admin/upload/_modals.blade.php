        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="lead">
                    ...
                    确定删除
                    <kdb><span id="delete-file-name1">file</span></kdb>
                    这个文件吗？
                </p>
            </div>
        ...
        <div class="modal-content">
            <form method="POST" action="/admin/upload/file" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="file_name" class="col-sm-3 col-form-label">文件名（可选）</label>
                        <div class="col-sm-8">
...
<div class="modal fade" id="modal-image-view">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img id="preview-image" src="x" class="img-responsive" style="width: 100%;" alt="">
            </div>
